 ...
 * </ul>
 */
public class CompressionDataWriter<T> extends FsDataWriter<T> {
  ...
  public CompressionDataWriter(FsDataWriterBuilder<?, T> builder, State properties) throws IOException {
  ...
  public boolean isSpeculativeAttemptSafe() {
    return this.writerAttemptIdOptional.isPresent() && this.getClass() == CompressionDataWriter.class;
  }
}
